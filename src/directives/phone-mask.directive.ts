    ...
    phoneValidate() {
        ...
        this.sub = this._phoneControl.valueChanges.subscribe(data => {
            ...
            */
            ...
            let start = this.renderer.selectRootElement('#mobile').selectionStart;
            let end = this.renderer.selectRootElement('#mobile').selectionEnd;
            ...
            if (data.length < preInputValue.length) {
                ...
                this.renderer.selectRootElement('#mobile').setSelectionRange(start, end);
                ...
                if (preInputValue.length >= start) {
                    ...
                    this._phoneControl.setValue(newVal, { emitEvent: false });
                    this.renderer.selectRootElement('#mobile').setSelectionRange(start + 2, end + 2); // +2 because of wanting standard typing
                }
            }
        });
    }
